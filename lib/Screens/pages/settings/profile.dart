...
// ══════════════════════════════════════════════════════════════════════════════
//  PROVIDERS  — wire these up to your actual notifier
//  Replace the placeholder implementations below with your real providers.
// ══════════════════════════════════════════════════════════════════════════════
...
class ProfileState {
  ...
  final String? avatarUrl; // network URL from Firestore / storage
  final File? localAvatar; // picked file before upload
...
class ProfileNotifier extends StateNotifier<ProfileState> {
  ...
  Future<void> updateProfile({
    ...
    // TODO: call your Firestore / backend update logic here
  ...
  Future<void> updateAvatar(File file) async {
    // TODO: upload to Firebase Storage, then update avatarUrl
...
class _ProfilePageState extends ConsumerState<ProfilePage>
  ...
  static const _countries = [
    ...
    'United States', 'Canada', 'Germany', 'France', 'India',
    'Brazil', 'Australia', 'Japan', 'China', 'Egypt',
  ];
  ...
  void initState() {
    ...
    _selectedCountry = profile.country.isNotEmpty ? profile.country : null;
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: const Icon(Icons.arrow_back_ios_new_rounded,
              color: Color(0xFF1A2B3C), size: 20),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // ── Avatar section ───────────────────────────────────
            Center(child: _AvatarSection(profile: profile, onTap: _pickAvatar)),
                ...
                child: Container(
                  ...
                  child: ClipOval(
                    child: profile.localAvatar != null
                        ? Image.file(profile.localAvatar!,
                            fit: BoxFit.cover,
                            width: 94,
                            height: 94)
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    shape: BoxShape.circle,
                    border: Border.all(color: const Color(0xFFF2F6FB), width: 2),
                    boxShadow: [
                      BoxShadow(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      items: countries
                          ...
                          .toList(),
                      onChanged: isUnlocked ? onChanged : null,
                    ),
                  ),
                ),
              ),
